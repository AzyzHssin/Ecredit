//package com.Ecredit.demo.Config;
...
//                    .apis(RequestHandlerSelectors.basePackage("com.Ecredit.demo")) // basePackage permet de demander à Swagger de ne rien documenter en dehors du package "com.esprit.examen".
